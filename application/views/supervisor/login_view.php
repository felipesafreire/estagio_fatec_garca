        ...
        <div class="form-signin login">
          <div class="panel periodic-login">
              ...
              <div class="panel-body text-center">
                  <p class="element-name"><img  class="img-responsive" src="<?=base_url('assets/img/logo_fatec.png');?>" title="Sistema de Gerenciamento de Estágio"></p>
                  
                  <h5 class="text-center"><strong>Supervisão de Estágio</strong></h5>
          ...
          <div class="panel periodic-login">
              <div class="panel-body text-center">
                  <p class="element-name"><img  class="img-responsive" src="<?=base_url('assets/img/logo_fatec.png');?>" title="Sistema de Gerenciamento de Estágio"></p>
                    ...
                    <div id="spAvisoPeriodo"></div>
                    
                  <button id="btnEntrar" class="btn col-md-12">Entrar</button>
              </div>
          </div>
        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#btnLogar").click(function(){
            ...
            if($(".danger").length > 0){
               ...
               $("#spAviso").html('<strong>Verifique os campos antes de continuar...</strong>').show();
                ...
                $.post('<?=base_url('supervisor/dashboard/entrar');?>',
                ...
                function(retorno){
                    ...
                    if(retorno.result==true){
                        ...
                        }else if(retorno.ok==2){

                            window.location=retorno.url;

                        }else{
                        
                            seleciona_periodo(retorno.html);
        ...
        $("#btnAlterarSenha").click(function(){
            ...
            if(email==""){
                ...
                window.location = '<?=base_url('supervisor/dashboard/login');?>';
            ...
            if($(".danger").length > 0){
               ...
               $("#spAvisoSenha").html('<strong>Verifique os campos antes de continuar...</strong>').show();
                ...
                $.post('<?=base_url('supervisor/dashboard/primeiro_acesso');?>',
        ...
        $("#btnEntrar").click(function(){
            ...
            if(periodo==0){
                ...
                $.post('<?=base_url('supervisor/dashboard/set_periodo');?>',
                {'periodo':periodo},
                function(retorno){
        ...
        $("#btnEsqueceuSenha").click(function(){
            ...
            if($(".danger").length > 0){
               ...
               $("#spAvisoSenhaEsqueceu").html('<strong>Verifique os campos antes de continuar...</strong>').show();
                ...
                $.post('<?=base_url('supervisor/dashboard/esqueceu_senha');?>',
                {'email':email},
                function(retorno){
    ...
    function seleciona_periodo(html){
